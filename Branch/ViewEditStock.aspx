<%@ Page Title="" Language="C#" MasterPageFile="~/Branch/Master.Master" AutoEventWireup="true" CodeBehind="ViewEditStock.aspx.cs" Inherits="SchoolManagementSystem.Branch.ViewEditStock" %>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-heading">Stock Detail
                </div>
                      ...
                      <asp:Repeater ID="rptStock" runat="server">
                          <ItemTemplate>
                              ...
                              <td><%# Eval("[Item]") %></td>
                                ...
                                <td class="center">
                                  <asp:LinkButton ID="btnEdit" runat="server" OnClick="btnEdit_Click" CommandArgument='<%# Eval("StockID") %>'><span class="mdi mdi-edit" style="font-size: 22px!important;"></span></asp:LinkButton>
                                 <%-- <asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_Click" CommandArgument='<%# Eval("StockID") %>' OnClientClick='return confirm("Are you sure you want to delete this item?")'><span class="mdi mdi-delete" style="font-size: 22px!important;"></span></asp:LinkButton>--%>
                                </td>
                              </tr>
