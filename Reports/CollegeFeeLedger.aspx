<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CollegeFeeLedger.aspx.cs" Inherits="SchoolManagementSystem.Reports.CollegeFeeLedger" %>
...
<head runat="server">
    ...
    <title>College Fee Ledger</title>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           COLLEGE FEE COLLECTION DETAIL LEDGER PAK PEARL GROUP OF SCHOOL & COLLEGE D.I.KHAN CAMPUS
                        ...
                        <div class="panel-body">
                            <table class="table table-condensed table-hover table-bordered table-striped">
                                ...
                                <tbody>
                                     <asp:Repeater ID="rptCollegeFeeLedger" runat="server">
                                        <ItemTemplate>
                                       <tr>
                                            <td><%# Eval("SrNo") %></td>
                                            ...
                                            <td><%# Eval("ReAdmissionFee") %></td>
                                            <td><%# Eval("Arrears") %></td>
                                            <td><%# Eval("MonthlyPayable") %></td>
                                            <td><%# Eval("Apr") %></td>
                                            <td><%# Eval("May") %></td>
                                            <td><%# Eval("June") %></td>
                                            <td><%# Eval("July") %></td>
