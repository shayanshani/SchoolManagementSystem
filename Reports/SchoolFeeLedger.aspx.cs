...
{
    public partial class SchoolFeeLedger : System.Web.UI.Page
    {
        ...
        {
            rptSchoolFeeLedger.DataSource = helper.ExecutePlainQuery("select * from vw_StudentFee where ClassNo=" + ddlClass.SelectedValue + " and BranchID=" + ddlBranch.SelectedValue + " and year(enrollmentdate)=" + ddlSession.Text + " and LedgerType='School'");
            rptSchoolFeeLedger.DataBind();
        }
